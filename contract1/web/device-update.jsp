                    ...
                    <div class="panel-body">
                        <form action="device" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">设备序号</label>
                                <div class="col-sm-5">
                                    <input type="text" name="device_id" class="form-control" value="${param.device_id}"  readonly="readonly" placeholder="设备编号">
                                </div>
                                <div class="col-sm-5">
                                    <p class="form-control-static text-danger">设备序号不能修改</p>
                                </div>
                            </div>
                            <div class="form-group">
